	...
	{#if post.feature_image}
        ...
        https://medium.freecodecamp.org/a-guide-to-responsive-images-with-ready-to-use-templates-c400bd65c433 -->
			<img
				...
				srcset="{img_url(imgOrigin, post.feature_image, ENUM_IMAGE_SIZE.S)} 300w,
                    {img_url(imgOrigin, post.feature_image, ENUM_IMAGE_SIZE.M)} 600w,
                    {img_url(imgOrigin, post.feature_image, ENUM_IMAGE_SIZE.L)} 1000w,
                    {img_url(imgOrigin, post.feature_image, ENUM_IMAGE_SIZE.XL)} 2000w"
				sizes="(max-width: 1000px) 400px, 800px"
				src={img_url(imgOrigin, post.feature_image, ENUM_IMAGE_SIZE.M)}
				loading="lazy"
			/>
