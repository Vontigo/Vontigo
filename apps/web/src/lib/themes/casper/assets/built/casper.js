!(function (e, t) {
		...
		function s(e, t, i) {
			...
			return (o = 'string' == typeof e ? document.querySelectorAll(e) : o)
				? ((this.elements =
				  ...
				  i && this.on('always', i),
				  this.getImages(),
				  d && (this.jqDeferred = new d.Deferred()),
			...
			(s.prototype.addElementImages = function (e) {
				...
				if (t && c[t]) {
					...
					if ('string' == typeof this.options.background)
						for (var r = e.querySelectorAll(this.options.background), n = 0; n < r.length; n++) {
							var s = r[n];
		...
		return (
			...
			(s.prototype.complete = function () {
				...
				(this.isComplete = !0),
					...
					this.jqDeferred &&
						((e = this.hasAnyBroken ? 'reject' : 'resolve'), this.jqDeferred[e](this));
			}),
			...
			(s.makeJQueryPlugin = function (e) {
				(e = e || t.jQuery) &&
					((d = e).fn.imagesLoaded = function (e, t) {
						return new s(this, e, t).jqDeferred.promise(d(this));
					});
			})(),
			s
		);
				...
				this.each(function () {
					...
					(e = (e = e.not('object object')).not(n)).each(function () {
						...
						0 < i.parents(n).length ||
							...
							i.attr('name') ||
								((t = 'fitvid' + r.fn.fitVids._count), i.attr('name', t), r.fn.fitVids._count++),
							i
								.wrap(
	...
	(function () {
		...
		const e = document.querySelector('.gh-head'),
			o = e.querySelector('.gh-head-menu'),
			r = o.querySelector('.nav');
		if (r) {
			document.querySelector('.gh-head-logo');
			var s,
				t = r.innerHTML;
			if (n.matches) {
				const d = r.querySelectorAll('li');
			...
			function i() {
				if (!n.matches) {
					const e = [];
					for (; r.offsetWidth + 64 > o.offsetWidth; ) {
						...
						i.setAttribute('class', 'gh-dropdown'),
							10 <= e.length
								? (document.body.classList.add('is-dropdown-mega'),
								  (i.style.gridTemplateRows = 'repeat(' + Math.ceil(e.length / 2) + ', 1fr)'))
			...
			imagesLoaded(e, function () {
				...
				window.addEventListener('resize', function () {
					setTimeout(function () {
						window.removeEventListener('click', s), (r.innerHTML = t), i();
					}, 1);
				});
		}
	})(),
	(function (t, i) {
		...
		function l() {
			if (404 === this.status)
				return t.removeEventListener('scroll', m), void t.removeEventListener('resize', p);
			...
			e
				? (n.href = e.href)
				: (t.removeEventListener('scroll', m), t.removeEventListener('resize', p)),
		...
		function p() {
			(h = t.innerHeight), (c = i.documentElement.scrollHeight), u();
		}
		i.documentElement.classList.contains('no-infinite-scroll') ||
			!(n = i.querySelector('link[rel=next]')) ||
